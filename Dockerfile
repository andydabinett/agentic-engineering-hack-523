...
ENV PORT=3000
ENV WEB_PORT=3000
ENV CORRESPONDENCE_PORT=3001
ENV CORRESPONDENCE_API_URL=http://127.0.0.1:3001
ENV CORRESPONDENCE_ENABLED=1
ENV CORRESPONDENCE_DEV=0
ENV CORRESPONDENCE_FAKE_DEMO=0
